...
# demo_sixth_mode = False
# demo_seventh_mode = False
# demo_eighth_mode = False
# demo_nineth_mode = False
...
fast_relax.respect_initial_assignment_for_initializing_beliefs = False
