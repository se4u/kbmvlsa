...
RESCAL, VN and KBC-VN.\note{In this dataset P@5, P@10 don't make
a lot of sense since there are only at most 1, 2 or 3 correct answers.}

\begin{table}[htbp]
  \centering
  \begin{tabular}{l c c c c}
    Method & AUPR & P@1  & \alert{P@5} & \alert{P@10} \\
    RESCAL &  0.79 & 0.78 & 0.17 & 0.09 \\
    VN     &  \alert{0.46} \\
    MAD    &  0.79 & 0.75 & 0.17 & 0.10 \\
  \end{tabular}
